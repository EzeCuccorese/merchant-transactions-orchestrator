...
import com.merchant.orchestration.domain.exception.BusinessException;
import com.merchant.orchestration.domain.exception.NumeratorConflictException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleBusinessException(final BusinessException ex) {
        ...
        pd.setType(URI.create("https://merchant.com/errors/business-error"));
    ...
    public ResponseEntity<ProblemDetail> handleNotFoundException(final TransactionNotFoundException ex) {
        ...
        pd.setType(URI.create("https://merchant.com/errors/not-found"));
    ...
    public ResponseEntity<ProblemDetail> handleValidationException(final MethodArgumentNotValidException ex) {
        ...
        pd.setType(URI.create("https://merchant.com/errors/validation-error"));
    ...
    public ResponseEntity<ProblemDetail> handleCircuitBreakerOpenException(final CallNotPermittedException ex) {
        ...
        pd.setType(URI.create("https://merchant.com/errors/service-unavailable"));
    ...
    public ResponseEntity<ProblemDetail> handleServerErrorException(final Exception ex) {
        ...
        pd.setType(URI.create("https://merchant.com/errors/internal-server-error"));
        pd.setTitle(title);
        pd.setProperty("timestamp", Instant.now());
